...
class AssetDepreciationConfirmationWizard(models.TransientModel):
    _name = "custom.asset.depreciation.confirmation.wizard"
    _description = "custom.asset.depreciation.confirmation.wizard"
    ...
    def asset_compute(self):
        ...
        created_move_ids = self.env['custom.account.asset.asset'].compute_generated_entries(self.date, asset_type=context.get('asset_type'))
