...
class AccountBankBookReport(models.TransientModel):
    _name = "custom.account.bankbook.report"
    ...
    account_ids = fields.Many2many('account.account', 'custom_account_account_bankbook_report', 'report_line_id',
    ...
    def check_report(self):
        ...
        return self.env.ref(
            'custom_accounting_kit.action_report_bank_book').report_action(self,
                                                                     data=data)
