...
class AccountCashBookReport(models.TransientModel):
    _name = "custom.account.cashbook.report"
    ...
    account_ids = fields.Many2many('account.account', 'custom_account_account_cashbook_report', 'report_line_id',
    ...
    def check_report(self):
        ...
        return self.env.ref(
            'custom_accounting_kit.action_report_cash_book').report_action(self,
                                                                     data=data)
