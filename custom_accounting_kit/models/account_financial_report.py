...
class AccountFinancialReport(models.Model):
    _name = "custom.account.financial.report"
    ...
    parent_id = fields.Many2one('custom.account.financial.report', 'Parent')
    children_ids = fields.One2many('custom.account.financial.report', 'parent_id', 'Account Report')
    ...
    account_ids = fields.Many2many(
        'account.account', 'custom_account_account_financial_report',
        'report_line_id', 'account_id', 'Accounts'
    )
    account_report_id = fields.Many2one('custom.account.financial.report', 'Report Value')
    account_type_ids = fields.Many2many(
        'custom.account.account.type', 'custom_account_account_financial_report_type',
    ...
    children_ids = fields.One2many('custom.account.financial.report', 'parent_id', string='Children')
